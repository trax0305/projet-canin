                      ...
                      <?php if (isset($appointmentDetails)): ?>
                          <div>
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="datetime-local" class="form-control" name="date_start" value="<?php echo $appointmentDetails['date_start']; ?>">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="is_paid" value="<?php echo ($isPaid == 1) ? 'Payé' : 'Non payé'; ?>">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name="animal_name" value="<?php echo $animalName ?>">
                              </div>
                              <div class="form-group">
                                  <label for="service_name">Service:</label>
                                  <input type="text" class="form-control" name="service_name" value="<?php echo $serviceName ?>">
                              </div>
