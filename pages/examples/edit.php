...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $user_update = $user_instance->updateUser($_POST);
}
          ...
          <div class="card card-primary">
            ...
            <form method='post' class='customer-form'>
              ...
              <div class="form-group">
                ...
                <input type="text" name="inputName" id="inputName" class="form-control" value="<?= $user_config->lastname ?>">
              </div>
              <div class="form-group">
                <label for="inputPrénom">Prénom</label>
                <input type="text" name="inputPrénom" id="inputPrénom" class="form-control" value="<?= $user_config->firstname ?>">
              </div>
              <div class="form-group">
                <label for="inputAdress">Adresse postale</label>
                <input type="text" name="inputAdress" id="inputAdress" class="form-control" value="<?= $user_config->address  ?>">
              </div>
              <div class="form-group">
                <label for="inputEmail">Email</label>
                <input type="text" name="inputEmail" id="inputEmail" class="form-control" value="<?= $user_config->email ?>">
              </div>
              <div class="form-group">
                <label for="inputTelephone">Telephone</label>
                <input type="text" name="inputTelephone" id="inputTelephone" class="form-control" value="<?= $user_config->telephone ?>">
              </div>
